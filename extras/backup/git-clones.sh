...
ssh root@services cd /var/git/gpte-ng-dmf/ && git init --bare
ssh root@services cd /var/git/gpte-ng-dmf/ && git update-server-info
ssh root@services cd /var/git/gpte-ng-dmf/ && chown -R apache:apache .
ssh root@services cd /var/git/gpte-ng-dmf/ && chcon -R -t git_rw_content_t .
...
ssh root@services cd /var/git/bxms_decision_mgmt_foundations_lab/ && git init --bare
ssh root@services cd /var/git/bxms_decision_mgmt_foundations_lab/ && git update-server-info
ssh root@services cd /var/git/bxms_decision_mgmt_foundations_lab/ && chown -R apache:apache .
ssh root@services cd /var/git/bxms_decision_mgmt_foundations_lab/ && chcon -R -t git_rw_content_t .
...
ssh root@services cd /var/git/dm7-customer-greeting/ && git init --bare
ssh root@services cd /var/git/dm7-customer-greeting/ && git update-server-info
ssh root@services cd /var/git/dm7-customer-greeting/ && chown -R apache:apache .
ssh root@services cd /var/git/dm7-customer-greeting/ && chcon -R -t git_rw_content_t .
...
ssh root@services cd /var/git/business-process-apps-training/ && git init --bare
ssh root@services cd /var/git/business-process-apps-training/ && git update-server-info
ssh root@services cd /var/git/business-process-apps-training/ && chown -R apache:apache .
ssh root@services cd /var/git/business-process-apps-training/ && chcon -R -t git_rw_content_t .
...
ssh root@services cd /var/git/business-process-apps-training-lab/ && git init --bare
ssh root@services cd /var/git/business-process-apps-training-lab/ && git update-server-info
ssh root@services cd /var/git/business-process-apps-training-lab/ && chown -R apache:apache .
ssh root@services cd /var/git/business-process-apps-training-lab/ && chcon -R -t git_rw_content_t .
...
ssh root@services cd /var/git/rhpam7-mortgage-demo-repo/ && git init --bare
ssh root@services cd /var/git/rhpam7-mortgage-demo-repo/ && git update-server-info
ssh root@services cd /var/git/rhpam7-mortgage-demo-repo/ && chown -R apache:apache .
ssh root@services cd /var/git/rhpam7-mortgage-demo-repo/ && chcon -R -t git_rw_content_t .
...
ssh root@services cd /var/git/advanced-process-development-labs-etc/ && git init --bare
ssh root@services cd /var/git/advanced-process-development-labs-etc/ && git update-server-info
ssh root@services cd /var/git/advanced-process-development-labs-etc/ && chown -R apache:apache .
ssh root@services cd /var/git/advanced-process-development-labs-etc/ && chcon -R -t git_rw_content_t .
